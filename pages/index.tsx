				...
				<div className="flex flex-col ">
                    ...
                    top-0 left-0 right-0 z-10 text-sm bg-tuna">
						<div className="m-2 pr-12 mr-10">
							<span className={isHome ? "text-md text-white" : "text-md text-light-blue"}>
								Zahwa&nbsp;
							</span>
							<span className="text-md text-white">Tri Riyanto</span>
						</div>
						<div className="m-2 md:pr-12 md:mr-10">
							<p className="text-md text-white">Currently Informatics Engineering</p>
							<p className="text-md text-white">Student at Tanjungpura University</p>
						</div>
						<div className="m-2 pr-12 mr-10">
                    ...
                    fixed top-0 left-0 right-0 z-10 text-sm">
						<div className="m-2">
							<button onClick={toHome}>
								<span className={isHome ? "text-light-blue" : "text-orange"}>
									{isHome ? "Welcome" : "Top"}
								</span>
							</button>
						</div>
						<div className="m-2">
							<button onClick={toAbout}>
								<span className={isAbout ? "text-light-blue" : "text-white"}>About Me</span>
							</button>
						</div>
						<div className="m-2	">
							<button onClick={toSkills}>
								<span className={isSkills ? "text-light-blue" : "text-white"}>My Skills</span>
							</button>
						</div>
						<div className="m-2	">
							<button onClick={toWorks}>
								<span className={isWorks ? "text-light-blue" : "text-white"}>My Works</span>
							</button>
						</div>
					</nav>
				</div>
