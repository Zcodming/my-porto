		...
		<div
			...
			<table className="text-xl w-full ">
				<tbody>
					<tr>
						{/* UI/UX 	*/}
						<td className="px-8 my-7 text-left text-orange">UI/UX DESIGN</td>
						<td
							...
							<div className="w-full bg-light-green rounded-full h-2.5 dark:bg-gray-700 my-7">
								<div className="bg-green h-2.5 rounded-full" style={{ width: "58%" }}></div>
							</div>
						...
						<td className="px-8 my-7 text-right" style={{ width: "204px" }}>
							<i>ADVANCE</i>
						</td>
					</tr>
					<tr>
						{/* Figma 	*/}
						<td className="px-8 my-7 text-left text-orange">FIGMA</td>
						<td
							className="relative text-center text-green"
							style={{ width: "300px", height: "71px" }}>
							<div className="w-full bg-light-green rounded-full h-2.5 dark:bg-gray-700 my-7">
					...
					<tr>
						{/* Figma 	*/}
						<td className="px-8 my-7 text-left text-orange">PHOTOSHOP</td>
						<td
							className="relative text-center text-green"
							style={{ width: "300px", height: "71px" }}>
							<div className="w-full bg-light-green rounded-full h-2.5 dark:bg-gray-700 my-7">
